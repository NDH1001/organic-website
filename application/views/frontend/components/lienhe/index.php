...
<section>
		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					...
					<span style="color: black"> Đại Học Hà Nội </span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
					<span style="color: black">0333.566.495</span>
				</li>
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"><a href="mailto:hagiakinh1123@gmail.com">hagiakinh1123@gmail.com</a></span>
				</li>
			</ul>
		</div>
	...
	<div class="col-md-12 col-lg-12 col-xs-12 col-12">
		...
		<div style="margin-top: 15px;">
			<iframe src="google.map" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
