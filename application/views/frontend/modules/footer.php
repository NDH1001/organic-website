<footer id="footer">
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <ul class="list-unstyled social pull-right">
                  <li><a href="https://www.facebook.com/fitonler/"><i class="fab fa-facebook-f"></i></a></li>
  ...
  <div class="top-footer">
            ...
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="clearfix">
                        ...
                        <span>0333566495</span>
                    </li>
                    <li class="clearfix">
                        <i class="fa fa-envelope"></i>
                        <span><a href="mailto:hagiakinh1123@gmail.com">hagiakinh1123@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-6">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
        <div class="col-xs-12 col-sm-6">
           <iframe src="https://www.google.com/maps/@20.988109,105.7952029,17.5z" width="423" height="157" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
        ...
        <div class="contact-title">
          <div class="contact-text-wrapper">
            ...
            <div class="text-center">
              <div><a href="tel:0333.566.495" rel="nofollow">0333.566.495 <b>(Mr. Kinh)</b></a><span> | </span><a href="tel:0333.566.495" rel="nofollow">0333.566.495 <b>(Mr. Kinh)</b></a></div>
              <div><span>Email: hagiakinh1123@gmail.com</span></div>
            </div>
          </div>
        </div>
        <div class="contact-set flex text-center">
          <div class="w-50">
            <a href="http://zalo.me/0333566495" rel="noopener nofollow" target="_blank" title="Chat Zalo">
          ...
          <div></div>
          <div class="w-50">
            <a href="https://www.messenger.com/t/100004660634023" title="Liên hệ">
